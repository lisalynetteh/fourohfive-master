...
<body class="sticky-footer">
	...
	<a class="sr-only" href="#content"><?php echo ''; ?></a>
...
<div class="header__title">
	...
	<img class= "header_image" src="<?php echo get_site_url();?>/wp-content/uploads/2017/11/Litz-1.png" style="width:50px;height:50px;border:0" > 
